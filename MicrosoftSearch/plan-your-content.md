...
ms.locfileid: "44535350"
---
# <a name="plan-your-content"></a>Планирование контента

**Служба поиска Майкрософт** помогает пользователям находить нужные материалы. **Поиск (Майкрософт)** — это безопасный способ поиска содержимого в интрасети и Интернете. Подобная интеграция Интернета и организации доступна только с корпорацией Майкрософт.
