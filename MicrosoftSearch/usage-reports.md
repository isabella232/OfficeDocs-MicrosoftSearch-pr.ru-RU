...
Предыдущая версия этой страницы включала данные из поисковых запросов, выполненных для Microsoft Search в Bing на Bing.com. Эти данные будут интегрированы в эти отчеты в ближайшее время, но на данный момент эти отчеты можно увидеть, щелкнув ссылку в нижней части страницы, чтобы просмотреть главные запросы и распределение впечатлений от **Bing.**
...
Загрузка отчета позволит вам видеть отчеты из более широкого диапазона времени. Щелкните стрелку загрузки и выберите **последние 31 день или** последние **12 месяцев.** Отчет загружается в качестве таблицы Excel. Если вы выбрали за 31 день, в таблице будет иметься индивидуальная вкладка для каждого дня. В течение последних 12 месяцев загрузка будет иметь вкладку для каждого месяца.

Чтобы просмотреть главные запросы и отчеты о распределении впечатлений в Bing, щелкните по ссылке на странице.
...
**Когда я увижу совокупные данные за последние 7 дней, последние 30 дней и т.д. ... например, отчеты о топовых запросах Bing?**
...
**Почему отчеты Microsoft Search in Bing на отдельной странице?**

Модернизация поиска в приложениях Office 365 в Microsoft Search требует, чтобы мы присоединились к ранее несопоставимой системе, в том числе к поколению отчетов. Это требует времени, и мы посчитали, что сейчас важнее получать эти отчеты, а не ждать, пока мы не завершим интеграцию данных Bing. После завершения интеграции данные из всех конечных точек поиска будут включены в те же отчеты.