...
Поиск (Майкрософт) пользователи могут получать определения с акронимами в [Bing,](https://Bing.com) [SharePoint](https://products.office.com/sharepoint/collaboration)и [Office 365](https://Office.com). В поле **Поиск** пользователи введите запросы, подобные этим примерам:
...
> [!NOTE]
> Для того чтобы аббревиатуры, добавленные в состояние Published, стали доступны в Поиск (Майкрософт), может потребоваться до трех дней.
...
**Ответ:** Чтобы получить ответы на аббревиатуры, пользователи должны ввести определенные шаблоны запросов в поле [Bing,](https://bing.com) [SharePoint](https://products.office.com/sharepoint/collaboration)или [Office 365](https://Office.com) **поиска.**
