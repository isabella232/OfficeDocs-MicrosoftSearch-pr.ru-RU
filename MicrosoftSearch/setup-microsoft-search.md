...
**Примечание.** Если **Поиск (Майкрософт)** НЕ отображается в **Центре администрирования Microsoft 365** в разделе **Параметры**, включите переключатель **Попробовать предварительную версию** в правом верхнем углу Центра администрирования. 
