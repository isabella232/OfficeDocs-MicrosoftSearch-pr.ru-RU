...
Чтобы настроить любой из встроенных соединителей Майкрософт, перейдите в [центр администрирования](https://admin.microsoft.com):
1. Войдите в свою учетную запись, используя учетные данные для тестового клиента [Microsoft 365](https://www.microsoft.com/microsoft-365) .
