...
# <a name="setup-overview-for-graph-connectors-by-microsoft"></a>Обзор установки Graph соединители Майкрософт 

В этой статье показан основной процесс, необходимый для Graph соединители **Майкрософт** в центре [администрирования Microsoft 365.](https://admin.microsoft.com) Базовый процесс состоит из следующих этапов:  
...
1. Вопишите свою учетную запись администратора [в Microsoft 365 центре администрирования.](https://admin.microsoft.com)
