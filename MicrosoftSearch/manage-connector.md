...
--- | --- | ---
Добавление подключения | :heavy_check_mark: (См. ["Настройка соединитела, встроенного в Майкрософт")](configure-connector.md) | :x: (Обратитесь к партнеру или администратору настраиваемого соединитела)
...
* Определите подключения, которые имеют слишком много содержимого, и обновим их, чтобы проиндексировать меньше элементов, чтобы уместить квоту. Чтобы обновить подключение, необходимо удалить и создать новое подключение с помощью нового фильтра ingestion, который обеспечивает меньшее количество элементов.

* Окончательное удаление одного или более подключений

## <a name="limitations"></a>Ограничения

* При **публикации** соединители, созданные корпорацией Майкрософт, может потребоваться несколько минут для создания подключения. В течение этого времени подключение будет отложено.
