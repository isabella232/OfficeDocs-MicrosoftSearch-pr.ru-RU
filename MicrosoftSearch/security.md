...
- Ведение журнала
  ...
  - Все журналы поисковых запросов, относящиеся к трафику Поиска (Майкрософт), обезличиваются и хранятся отдельно от общедоступного, не относящегося к Поиску (Майкрософт) трафика. Они хранятся в течение 18 месяцев, и доступ к ним разрешен только для целей отладки.
    
  - Запросы в этих журналах не используются для моделирования или отладки общедоступных функций, таких как автозаполнение или связанные поисковые запросы для общедоступной веб-части.
